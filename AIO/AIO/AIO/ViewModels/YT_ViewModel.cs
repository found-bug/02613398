...
{
    class YoutubeViewModel : INotifyPropertyChanged
    {
        ...
        private const string ApiKey = "AIzaSyBgaaSnrkgt5feFXXu91eJPQTIrFfWH8nA";
        ...
        public async Task<List<string>> InitDataAsync()
        {
